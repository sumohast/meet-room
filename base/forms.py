...
class ReservationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'initial' in kwargs and 'time_slot' in kwargs['initial']:
            ...
            ('07:25-08:00', '07:25 - 08:00'),
            ('08:00-09:00', '08:00 - 09:00'),
            ('09:00-10:00', '09:00 - 10:00'),
            ('10:03-11:00', '10:03 - 11:00'),
            ('11:05-12:00', '11:05 - 12:00'),
            ('12:13-13:00', '12:13 - 13:00'),  # اضافه کردن زمان ناهار
            ('13:20-14:00', '13:20 - 14:00'),
            ('14:20-15:00', '14:20 - 15:00'),
            ('15:35-16:00', '15:35 - 16:00'),
            ('16:31-17:00', '16:31 - 17:00'),
            ('17:02-18:00', '17:02 - 18:00'),  # اضافه کردن زمان‌های عصر
            ('18:52-20:00', '18:52 - 20:00'),
            #('20:11-20:00', '19:11 - 20:00'),
            ('20:10-21:00', '20:10 - 21:00'),  # اضافه کردن زمان‌های شب
